...
* [Qt](http://qt-project.org/) :zap: - A cross-platform application and UI framework. [LGPL]
...
* [MeTA](https://github.com/meta-toolkit/meta) - A modern C++ data sciences
  toolkit featuring multilingual text tokenization, a customizable search
  engine, machine learning algorithms, POS-tagging, grammatical parsing, and
  more. [MIT] [website](https://meta-toolkit.org/)
