 ...
 * [Rogueutil](https://github.com/sakhmatd/rogueutil) - Cross-platform C/C++ library for creating text-based user interfaces (TUI) and console-based games. [Apache-2.0]
