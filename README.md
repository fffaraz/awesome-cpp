...
* [notorch](https://github.com/ariannamethod/notorch) - Neural network training library in pure C with reverse-mode autograd and optional BLAS acceleration. [LGPL]
