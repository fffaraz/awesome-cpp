...
## Build Systems
* [Zyn](https://github.com/zyntraxis-corp/zyn) - Minimalist build tool that adds GitHub C++ libraries with a single line. [MIT](https://github.com/zyntraxis-corp/zyn/blob/main/LICENSE) [website](https://github.com/zyntraxis-corp/zyn)
