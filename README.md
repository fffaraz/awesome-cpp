...
* [Lex](https://github.com/David-Imperium/Lex-compiler) - A declarative, multi-target transpiler for game modding and code generation. Outputs Lua, GDScript, C#, JSON, and more. [MIT]
