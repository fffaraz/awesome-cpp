...
* [Molybden](https://teamdev.com/molybden) - An SDK for building cross-platform desktop apps with C++ backend and HTML/CSS/JS frontend GUI. [Free/Commercial] [website](https://teamdev.com/molybden)
