...
* [ariannamethod.ai](https://github.com/ariannamethod/ariannamethod.ai) - Domain-specific language for defining, training, and running transformers with 80+ internal state parameters. Compiles to C. [LGPL]
