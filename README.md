...
* [AREG SDK](https://github.com/aregtech/areg-sdk) - Cross-platform interface-centric communication engine that automates real-time data transmission between connected Things, allowing them to interact like a distributed servers and clients in the network. [Apache2] [website](https://www.aregtech.com/)
