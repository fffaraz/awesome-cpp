...
* [RenWeb](https://github.com/spur27/RenWeb-Engine) - Cross-platform desktop app framework using native webviews with an HTML/CSS/JavaScript frontend and C++ backend. [Boost]
