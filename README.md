...
* [Simple-Web-Server](https://github.com/eidheim/Simple-Web-Server) - simple, fast, multithreaded, cross platform web server and client library implemented using C++11 and Boost.Asio. [MIT]
* [Simple-WebSocet-Server](https://github.com/eidheim/Simple-WebSocket-Server) - simple, fast, multithreaded, cross platform WebSocket server and client library implemented using C++11, Boost.Asio and OpenSSL. [MIT]
