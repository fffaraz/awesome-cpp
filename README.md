...
* [reflect-cpp](https://github.com/getml/reflect-cpp) JSON serialization through reflection, including automatic field name retrieval from structs. [MIT]
...
* [reflect-cpp](https://github.com/getml/reflect-cpp) Serialization through reflection, including automatic field name retrieval from structs. Like Pyddantic or serde, but for C++. [MIT]
