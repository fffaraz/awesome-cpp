...
* [jsoncons](https://github.com/danielaparker/jsoncons) - A C++ header-only library for JSON and JSON-like data formats with JSONPointer, JSONPatch, JSONPath and JMESPath. [Boost]
