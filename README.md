...
_Libraries for parsing and manipulating xlsx, pptx, docx, etc._
...
- [Patternia](https://github.com/sentomk/patternia) - Header-only compile-time pattern matching DSL for modern C++ (17+). [MIT]
...
#### _If you see a project or link here that is no longer maintained or is not a good fit, please submit a pull request to improve this document. Thank you!_
