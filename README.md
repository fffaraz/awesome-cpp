...
* [Nova](https://github.com/kmac-13/nova) - A domain-based, compile-time routed C++11+ logging system with deterministic memory usage and async-signal-safe crash forensics. [BSD-3-Clause]
